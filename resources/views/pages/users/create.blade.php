            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        New User
                        <a class="float-right" href="{{ route('orders.index') }}"><button type="button" class="btn btn-info">User List</button></a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body card-block">
                            <div class="row form-group">
                                ...
                                <div class="col-md-10">
                                    {!! Form::select('user_type', ['admin' => 'Admin', 'supplier' => 'Supplier'], null, ['placeholder' => 'Select User Type...', 'class' => 'form-control']); !!}
                                    @error('user_type')
